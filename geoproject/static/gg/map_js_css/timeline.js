(function($) {
    ...
    $.fn.navigationWizard = function(options) {
        ...
        //Load Locations
        $.getJSON("maptheat237\geoproject\static\gg\map_js_css\icon.json", function (data) {
            localStorage.locationData = JSON.stringify(data);
        });


        $.getJSON("maptheat237\geoproject\static\gg\map_js_css\heatmap.json", function (data) {
            var steps = '';
